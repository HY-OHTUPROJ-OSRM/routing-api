...
-- Add the profiles path to Lua's package search path
local profiles_path = os.getenv("PROFILES_PATH") or "/usr/local/share/osrm/profiles"
package.path = profiles_path .. "/?.lua;" .. profiles_path .. "/lib/?.lua;" .. package.path
